...
public class BookController {
    ...
    @GetMapping("/all")
    public ResponseEntity<Page<Book>> getAllBookPage(@PageableDefault(size = 12)Pageable pageable) {
...
// detail
    ...
    @GetMapping("/search")
    public ResponseEntity<Page<Book>> search(@RequestParam String q, @PageableDefault(size = 12) Pageable pageable) {
